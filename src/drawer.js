...
export function createDrawer() {
  // Module state outlives the page under client-side routing: without this,
  // a drawer left open before navigating away keeps isOpen true, and the next
  // openDrawer() early-returns against freshly built DOM.
  isOpen = false
...
export function openDrawer(onCloseCallback) {
  // Rebuild if a navigation detached the previous drawer.
  if (!drawerEl || !drawerEl.isConnected) createDrawer()
  if (isOpen) return
